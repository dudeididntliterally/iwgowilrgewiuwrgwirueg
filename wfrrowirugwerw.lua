...
Fun:AddTextbox({
Name = "Bypass Text (Server Shout) BUY FIRST",
Default = "Text Here",
TextDisappear = true,
Callback = function(BRO)
local args = {
...
game:GetService("ReplicatedStorage").Remote_Events.General.ChangeName:FireServer(unpack(args))
end})
